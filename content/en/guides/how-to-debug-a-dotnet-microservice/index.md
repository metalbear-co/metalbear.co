...
3. Deploy the application to mimic a staging environment setup.
...
Install the mirrord CLI to run the Guestbook service within the context of the cluster so that it is able to communicate with the redis service in the cluster. Follow the installation guide for mirrord [here](/mirrord/docs/overview/quick-start/#installation).
