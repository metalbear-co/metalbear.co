...
[agent](/mirrord/docs/reference/architecture/#mirrord-agent) on the same node as the target, which helps
...
Check out the [mirrord docs](/mirrord/docs/overview/introduction/), especially the 
